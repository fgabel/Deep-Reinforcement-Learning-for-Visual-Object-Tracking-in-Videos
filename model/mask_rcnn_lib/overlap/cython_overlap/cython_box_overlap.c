...
static const char __pyx_k_root_share_project_kaggle_scien[] = "/root/share/project/kaggle/science2018/build/dummy-13-00/model/mask_rcnn_lib/overlap/cython_overlap/cython_box_overlap.pyx";
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cython_box_overlap", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
